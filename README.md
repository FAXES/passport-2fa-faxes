...
Originally based off of `passport-2fa-totp`.
...
```js
var GoogleAuthenticator = require('passport-2fa-faxes').GoogeAuthenticator;
...
`GoogleAuthenticator.verify(code, secret)` - Verify a 2FA code.
